...
enum class RegexFlag(
    ...
    UNICODE('u', "Unicode", "Enable Unicode-aware matching", RegexOption.CANON_EQ),
    COMMENTS('x', "Extended / Verbose", "Allow whitespace and comments in pattern", RegexOption.COMMENTS)
}
